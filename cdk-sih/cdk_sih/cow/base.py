...
class CdkCowBaseStack(Stack):
    def __init__(
        ...
        **kwargs,
        ...
        self.domain_name_it: str = factory.join_sep_empty([project_name, factory.DOT_IT_])
        self.hosted_zone_it: route53.HostedZone = factory.route53_hosted_zone_from_lookup(self, self.domain_name_it)

        factory.set_attrs_hosted_zone(self, domain_name=self.domain_name_it, hosted_zone=self.hosted_zone_it)
