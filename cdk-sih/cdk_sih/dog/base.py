...
class CdkDogBaseStack(Stack):
    def __init__(
        ...
        **kwargs,
        ...
        factory.set_attrs_ports_default(self, alb_port=4996)

        self.bastion_host_private_ips: list[str] = bastion_host_private_ips

        # Celery Task Subscriptions List
        self.task_subscriptions: list[str] = ["weather_change"]
        ...
        self.repo_ecomm: ecr.Repository = factory.ecr_repository(self, project_name_ecomm)
        ...
        factory.secrets_manager_secret_ecs_container(self, "fEnTG8")

        # ECS container API_KEYS secret
        factory.secrets_manager_secret_ecs_container(self, "EF1Owc", attr_name=factory.ECS_CONTAINER_API_KEYS_SECRET_)
